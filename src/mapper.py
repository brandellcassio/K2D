...
class Mapper:
    ...
    def get_matches(self, segments):
        self.query_match_handler.query_matches = []
        ...
        kw_schema_matches = self.keyword_match_handler.schema_keyword_match_generator(words, 
            self.index_handler.schema_index, threshold=self.config.similarity_threshold)
        ...
        self.query_match_handler.parallel_generate_query_matches(words, kw_candidate_query_matches, segments=segments)
        self.query_match_handler.parallel_rank_query_matches(self.index_handler.value_index, \
